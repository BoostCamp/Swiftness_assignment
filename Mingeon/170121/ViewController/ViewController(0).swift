...
//    }
    ...
    @IBAction func tap(_ sender: Any) {
        ...
        let libraryAction = UIAlertAction(title: "라이브러리", style: UIAlertActionStyle.default, handler: actionHandler)
        
        let albumAction = UIAlertAction(title: "사진앨범", style: UIAlertActionStyle.default, handler: actionHandler)
        let cancelAction = UIAlertAction(title: "취소", style: UIAlertActionStyle.cancel, handler: actionHandler)
